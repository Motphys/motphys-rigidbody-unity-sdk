...
namespace Motphys.Rigidbody.Native.Standard.Development.Editor
{
    internal class NativePluginSwitcher : IPreprocessBuildWithReport
    {
        ...
        private const bool ForDevelopmentBuildOnly = true;

        private const bool ForReleaseBuildOnly = false;

        private string GetPackageId() => "com.motphys.rigidbody.native.standard.development";
